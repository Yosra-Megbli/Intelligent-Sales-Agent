...
- Mention of Belgian distribution system operators (GRD) indicates the region: Fluvius corresponds to "Flandre"; ORES or RESA corresponds to "Wallonie". If the customer mentions ORES, RESA, or Fluvius, map this hint to the respective region ("Wallonie" or "Flandre").
...
Example 3:
Customer: "ORES/RESA en Wallonie"
Output:
{
  "event_type": "PROVIDE_INFORMATION",
  "entities": {
